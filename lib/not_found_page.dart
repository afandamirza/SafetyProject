...
class NotFoundPage extends StatefulWidget {
  ...
  const NotFoundPage({super.key, this.redirectUrl});

  @override
  State<NotFoundPage> createState() => _NotFoundPage();
}
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
            ...
            child: ListView(
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  accountEmail: Text('afanda@gmail.com'),
          ...
          // Ganti Placeholder dengan widget lain
          Expanded(
